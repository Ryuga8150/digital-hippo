            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, req.payload.find({
                            collection: "products",
                            // depth 0 refers to only bring user id
                            // depth 1 refers to bring all user data
                            depth: 0,
                            where: {
                                user: {
                                    equals: user.id,
...
exports.ProductFiles = {
    // slugs are referenced thats how we know its this relationTo it points to
    slug: "product_files",
    admin: {
        hidden: function (_a) {
            var user = _a.user;
    ...
    access: {
        ...
        // creating no need as if logged in you can create a product
        update: function (_a) {
            var req = _a.req;
