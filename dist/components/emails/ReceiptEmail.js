...
// since this file gets treated as module
// and react as a global is not able to get identified
// thus specified like this
        ...
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                ...
                products.map(function (product) {
                    var _a, _b;
                    var image = ((_a = product.images) === null || _a === void 0 ? void 0 : _a.at(0)).image;
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            product.description ? (React.createElement(components_1.Text, { style: productDescription }, product.description.length > 50
                                ? ((_b = product.description) === null || _b === void 0 ? void 0 : _b.slice(0, 50)) + "..."
...
// this is necessary as only HTML is required for emails
// so converting above react component
